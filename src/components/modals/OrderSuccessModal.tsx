...
const KITCHEN_STEPS = [
  {
    label: 'Cheddar Double Churned',
    icon: Flame,
    text: 'Proprietary golden sauce customized to perfection',
  },
  {
    label: 'Pizza Baked Hot',
    icon: Sparkles,
    text: 'Sizzling in the deck ovens at KAECHS Block 5',
  },
  {
    label: 'Drizzled & Loaded',
    icon: Layers,
    text: 'Smothering pizza and hot deals in warm cheese layers',
  },
  {
    label: 'Rider Out on KAECHS Lane',
    icon: MapPin,
    text: 'Speeding through Karachi, arriving gooey and fresh',
  },
];
          ...
          >
            ...
            <div className="bg-white border-2 border-[#C41E3A] rounded-2xl p-4 text-left space-y-3 font-mono text-xs text-[#C41E3A]/90 shadow-sm relative">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-[#1A1A1A]">
                  {orderDetails.itemsCount} portion(s)
                </span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="border-t-2 border-dashed border-[#C41E3A]/20 pt-4 space-y-4">
              <div className="flex justify-between items-center text-xs font-black uppercase text-[#C41E3A]/50">
                ...
                <span className="text-[#FFB81C] font-black font-mono animate-pulse">
                  SIZZLING...
                </span>
              </div>
              ...
              <div className="space-y-3 text-left">
                {KITCHEN_STEPS.map((step, i) => (
                  <div key={i} className="flex gap-3 items-start">
                    ...
                    <div>
                      <div className="text-xs font-black uppercase text-[#C41E3A]">
                        {step.label}
                      </div>
                      <div className="text-[10px] text-[#C41E3A]/70">
                        {step.text}
                      </div>
                    </div>
                  </div>
